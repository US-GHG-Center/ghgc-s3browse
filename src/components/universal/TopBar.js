...
export const TopBar = () => {
  ...
  return (
    <AppBar position="relative" sx={{ zIndex: (theme) => theme.zIndex.drawer + 1, bgcolor: '#F9F4F0', minHeight:  "100px", boxShadow: "none", display: 'flex', padding:"0px", justifyContent: 'center'}}>
        <Toolbar>
        {/* <Box
            sx={{width: 70}}
            component='img'
